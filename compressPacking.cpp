...
int main(int argc, char **argv) {
  // variables
  bool read = false, readState = false, lj = false, wca = false, doublelj = true, gforce = false, alltoall = false, nve = true;
  ...
  double LJcut = 4, cutDistance, cutoff = 1, forceTollerance = 1e-08, waveQ, FIREStep = 1e-02, dt = atof(argv[2]);

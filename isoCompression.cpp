...
int main(int argc, char **argv) {
  // variables
  bool read = true, readCellFormat = false;
  long numParticles = 128, nDim = 2, numVertexPerParticle = 32, numVertices;
  long iteration = 0, maxIterations = 5e06, printFreq = 1e05;
  long minStep = 20, numStep = 0, updateFreq = 10;
  long maxSearchStep = 500, searchStep = 0;
  double polydispersity = 0.17, previousPhi, currentPhi = 0.4, deltaPhi = 1e-03, scaleFactor;
  double cutDistance = 2., forceTollerance = 1e-12, pressureTollerance = 1e-10, pressure;
  double ea = 1e03, el = 1, eb = 1e-02, ec = 1, timeStep, dt0 = 1., forceCheck;
  double calA0 = 1.15, thetaA = 1., thetaK = 0., cutoff, maxDelta;

...
int main(int argc, char **argv) {
  // variables
  bool readAndMakeNewDir = false, readAndSaveSameDir = false, runDynamics = false, scaleVel = true, doubleT = false;
  ...
  double ea = 2, eb = 2, eab = 0.5, Tinject = atof(argv[3]), Tinject2 = atof(argv[8]);
